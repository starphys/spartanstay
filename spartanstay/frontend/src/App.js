    ...
    <>
      ...
      <div className="container">
        <Routes>
          ...
          <Route path = "/search" element={<Search savedPayments={savedPayments} setSavedPayments={setSavedPayments} results={results} setResults={setResults} token={token} setToken={setToken} setBookings={setBookings} search={search} setSearch={setSearch}/>} />
